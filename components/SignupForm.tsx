      ...
      >
        <div className=" bg-white rounded-2xl border shadow-sm p-6 sm:p-8">
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-xs text-gray-400 font-dmsans_light font-semibold">
              OR
            </span>
            <div className="flex-1 h-px bg-gray-200" />
          </div>
          ...
          <div className="flex flex-col justify-center items-center gap-2 sm:gap-3 w-full">
            <div className="space-y-1 relative w-full">
              ...
              />
              {errors.name && (
                <p className="text-xs text-red-500 font-dmsans_light left-0 absolute">
                  {errors.name.message}
                </p>
              )}
            </div>
            ...
            <div className="mt-4 space-y-1 relative w-full">
              ...
              />
              {errors.email && (
                <p className="text-xs left-0 text-red-500 font-dmsans_light absolute">
    ...
    >
      {loading ? (
        ...
        "Sign up"
          ...
          {success && (
            <p className="mt-3 text-center text-sm text-green-500 font-dmsans_light">
              {success}
            </p>
          )}
        </div>
