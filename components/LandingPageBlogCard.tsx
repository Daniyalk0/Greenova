...
const LandingPageBlogCard = () => {
    ...
    return (
        <div
            className={`w-full sm:w-[60%] md:w-[50%] lg:w-[25%] h-40 md:h-60 rounded-2xl shadow-2xl sm:h-48 relative px-3 py-2 sm:px-4  md:px-5 flex flex-col justify-between transition-all duration-700 cursor-pointer overflow-hidden `}
        ...
        >
            ...
            <div className="flex items-center justify-between relative ">
                ...
                <button className="relative p-3 bg-[#028445] rounded-full text-xs md:text-sm font-semibold shadow-md -rotate-45 overflow-hidden">
                    <motion.div
