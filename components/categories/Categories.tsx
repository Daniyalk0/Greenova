...
const categories = [
  { id: 1, name: "Fresh Fruits", color: "bg-red-200", height: "h-[10rem] sm:h-[27rem] md:h-[20rem]", contentHeight: "h-[55%] sm:h-[43%] md:h-[45%] ", img: "fruits.webp", bgImg: "phal-bg.png", btnBg: "bg-[#9B2B29]", sub_heading: "“Fresh, juicy, and healthy fruits to brighten every single day.“" },
  ...
  { id: 3, name: "Organic Vegetables", color: "bg-yellow-200", height: "h-[10rem] sm:h-[25rem] md:h-[17rem]", contentHeight: "h-[55%] sm:h-[46%] md:h-[60%] ", img: "organic-sabzi.webp", bgImg: "organic-sabzi-bg.png", btnBg: "bg-[#D34C07]", sub_heading: "“Fresh, nutritious vegetables bringing health, taste, and nature’s goodness daily.“" },
  ...
  { id: 5, name: "Exotic Fruits", color: "bg-purple-200", height: "h-[10rem]sm:h-[27rem] md:h-[13rem]", contentHeight: "h-[55%] sm:h-[42%] md:h-[82%] ", img: "exotic-phal.webp", bgImg: "exotic-phal-bg.png", btnBg: "bg-[#B9080F]", sub_heading: "“Experience exotic fruits with vibrant flavors from around the world“" },

  { id: 6, name: "Herbs", color: "bg-teal-200", height: "h-[10rem] sm:h-[26rem] md:h-[20rem]", contentHeight: "h-[55%] sm:h-[44%] md:h-[50%] ", img: "herbs.webp", bgImg: "herbs-bg.png", btnBg: "bg-[#028445]", sub_heading: "“Handpicked herbs offering wellness, freshness, and vibrant kitchen flavors.“" },
  ...
  { id: 9, name: "Dry Fruits", color: "bg-pink-500", height: "h-[10rem] sm:h-[16.2rem] md:h-[13.5rem]", contentHeight: "h-[55%] sm:h-[88%] md:h-[66%] ", img: "dry-phal.webp", bgImg: "dry-phal-bg.png", btnBg: "bg-[#A85923]", sub_heading: "“Crunchy dry fruits deliver health, flavor, and natural goodness daily.“" },
];
