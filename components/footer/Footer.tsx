...
before:bg-gradient-to-b before:from-[#76ff64bf] before:to-transparent 
 before:pointer-events-none">
            ...
            <img
                src="/branchBg.jpg"
                alt="Background"
                className="absolute w-[40%] h-[50%] left-[30%] object-cover opacity-90 bottom-0"
            />

            {/* Foreground content */}
            <FooterCard />
            <div className="footer w-full relative  text-gray-300 px-6 md:px-20 py-10 flex flex-col items-center justify-end">
                {/* Main Footer Section */}
                <div className="flex flex-col sm:flex-row justify-between gap-13 border-b border-gray-700 pb-8 w-full  ">
                    ...
                    <div className="w-full sm:w-[50%]">
                        ...
                        <p className="text-sm leading-6 font-monasans_semibold text-[#0f3c27]">
                    ...
                    <div className="flex flex-row sm:flex-row md:gap-16 gap-8 text-[#0f3c27]">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm flex flex-col gap-2 font-dmsans_light sm:font-monasans_semibold">
                                <li>
                                    <a href="https://twitter.com/daniyalkhandev" target="_blank" rel="noopener noreferrer" className="hover:text-[#0f6509] transition cursor-pointer duration-300">X (Twitter)</a>
                                </li>
                                <li>
                                    <a href="https://instagram.com/seemstobethend" target="_blank" rel="noopener noreferrer" className="hover:text-[#0f6509] transition cursor-pointer duration-300">Instagram</a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/in/daniyal-khan-648107263/" target="_blank" rel="noopener noreferrer" className="hover:text-[#0f6509] transition cursor-pointer duration-300">LinkedIn</a>
                                </li>
                                <li>
                                    <a href="https://discord.com/channels/@dan_webdev" target="_blank" rel="noopener noreferrer" className="hover:text-[#0f6509] transition cursor-pointer duration-300">Discord</a>
                                </li>
                            </ul>
                        </div>
