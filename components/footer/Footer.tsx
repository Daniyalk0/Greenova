...
const Footer = () => {
  return (
    <div
      className="w-full px-4 mt-36 sm:mt-40 relative flex justify-center pt-20 sm:pt-48 md:pt-32 lg:mt-48
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-12 border-b border-gray-700 pb-8 w-full  ">
          ...
          <div className="w-full sm:w-[50%]">
            ...
            <p className="text-sm leading-6  font-dmsans_light sm:font-monasans_semibold text-[#0f3c27]">
              Get farm-fresh fruits and vegetables delivered to your home.
              Handpicked daily, 100% natural, pesticide-free, and packed with
          ...
          <div className="flex flex-row sm:flex-row md:gap-16 gap-8 text-[#0f3c27]">
            <div>
              <h3 className="text-lg font-semibold text-white mb-3 font-dmsans_light hidden md:block">
                Useful Links
              </h3>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm flex flex-col gap-2 font-dmsans_light sm:font-monasans_semibold">
                <li>
                  <a
                    href="https://twitter.com/daniyalswe"
                    target="_blank"
                ...
                <li>
                  <a
                    href="https://instagram.com/unwrittenw0ounds"
                    target="_blank"
                    rel="noopener noreferrer"
                    className=" transition cursor-pointer duration-300 hover:underline"
                  >
                ...
                <li>
                  <a
                    href="https://discord.com/channels/@dan_webdev"
                    target="_blank"
                    rel="noopener noreferrer"
                    className=" transition cursor-pointer duration-300 hover:underline"
                  >
