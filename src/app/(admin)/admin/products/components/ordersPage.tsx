        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 w-full lg:w-auto">
          ...
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 sm:py-2.5 bg-white border border-gray-200 rounded-xl focus:outline-none focus:border-[#0c831f] focus:ring-4 focus:ring-[#0c831f]/10 text-[13px] sm:text-[14px] font-dmsans_light transition-all shadow-sm"
            />
          </div>

          {/* Filter */}
          <button className="flex items-center justify-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 border border-gray-200 rounded-xl bg-white hover:bg-gray-50 hover:text-[#0c831f] transition-colors text-[13px] sm:text-[14px] font-dmsans_semibold text-gray-700 shadow-sm flex-shrink-0">
      ...
      {orders.length === 0 ? (
        <div className="bg-white rounded-2xl border border-gray-200 py-16 sm:py-20 px-4 flex flex-col items-center text-center shadow-sm">
          <div className="w-16 sm:w-20 h-16 sm:h-20 bg-[#0c831f]/10 rounded-full flex items-center justify-center mb-4 sm:mb-5 border border-[#0c831f]/20">
            <PackageOpen className="w-8 sm:w-10 h-8 sm:h-10 text-[#0c831f] opacity-90" strokeWidth={1.5} />
          </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 py-16 sm:py-20 px-4 flex flex-col items-center text-center shadow-sm">
          <div className="w-14 sm:w-16 h-14 sm:h-16 bg-gray-100 rounded-full flex items-center justify-center mb-4 sm:mb-5 border border-gray-200">
            <Search className="w-6 sm:w-8 h-6 sm:h-8 text-gray-400" strokeWidth={1.5} />
          </div>
          <h3 className="font-monasans_semibold text-lg sm:text-xl text-gray-900 mb-2">
            No matching orders
          </h3>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <table className="w-full table-fixed border-collapse">
              ...
              <thead className="bg-gray-50/80 border-b border-gray-200">
                <tr>
                  <th className="px-3 sm:px-5 py-3 sm:py-4 text-[11px] sm:text-[12px] font-dmsans_semibold text-gray-500 uppercase tracking-wider">
                    Order ID
                  </th>
                  ...
                  <th className="hidden sm:table-cell px-3 sm:px-5 py-3 sm:py-4 text-[11px] sm:text-[12px] font-dmsans_semibold text-gray-500 uppercase tracking-wider">
                    Date
                  </th>
